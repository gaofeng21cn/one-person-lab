...
- The default local state directory is `~/Library/Application Support/OPL/state`. `OPL_STATE_DIR` is the preferred override; `OPL_FRONTDESK_STATE_DIR` remains a legacy-compatible alias.
