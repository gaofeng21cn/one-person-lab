...
test('product-entry docs freeze the managed external-kernel choice instead of fork or user-managed install', () => {
  ...
  assert.match(readme, /opl doctor/i);
  assert.match(readme, /opl ask/i);
  assert.match(readme, /opl chat/i);
  assert.match(readme, /opl contract validate/i);
  assert.match(readme, /opl domain manifests/i);
  assert.match(readme, /opl status runtime/i);
  assert.match(readme, /opl workspace bind/i);
  assert.match(readme, /opl frontdesk entry-guide/i);
  assert.match(readme, /opl session ledger/i);
  assert.match(readme, /opl runtime repair-gateway/i);
  assert.doesNotMatch(readme, /opl repair-hermes-gateway/i);
  assert.doesNotMatch(readme, /opl sessions/i);
  assert.doesNotMatch(readme, /opl logs/i);
  ...
  assert.match(readmeZh, /opl doctor/);
  assert.match(readmeZh, /opl ask/);
  assert.match(readmeZh, /opl chat/);
  assert.match(readmeZh, /opl contract validate/);
  assert.match(readmeZh, /opl domain manifests/);
  assert.match(readmeZh, /opl status runtime/);
  assert.match(readmeZh, /opl workspace bind/);
  assert.match(readmeZh, /opl frontdesk entry-guide/);
  assert.match(readmeZh, /opl session ledger/);
  assert.match(readmeZh, /opl runtime repair-gateway/);
  assert.doesNotMatch(readmeZh, /opl repair-hermes-gateway/);
  assert.doesNotMatch(readmeZh, /opl sessions/);
  assert.doesNotMatch(readmeZh, /opl logs/);
  ...
  assert.match(architecture, /opl contract validate/i);
