...
const registryCases = [
  ...
  ['packages install', 'packages_install', ['manifest-url', 'registry-url', 'package-id', 'trust-tier', 'source-kind', 'agent-root', 'dry-run'], 'OPL Packages'],
  ['packages update', 'packages_update', ['manifest-url', 'registry-url', 'package-id', 'trust-tier', 'source-kind', 'agent-root', 'dry-run'], 'OPL Packages'],
  ['packages repair', 'packages_repair', ['package-id', 'agent-root', 'dry-run'], 'OPL Packages'],
