...
test('runtime App drilldown retires stale typed blocker refs after same-cohort long operator evidence verifies', () => {
  withTempState('opl-app-release-user-path-blocker-retired-state-', (stateRoot) => {
    ...
    const evidenceRecord = recordAppReleaseUserPathEvidence(stateRoot, {
