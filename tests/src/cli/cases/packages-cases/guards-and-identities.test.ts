...
test('OPL Flow manifest resolves its package-owned 0.1.19 carrier and managed policy payload', () => {
  ...
  assert.equal(
    ...
    path.join(repoRoot, 'contracts', 'opl-framework', 'packages', 'payloads', 'opl-flow-0.1.19.json'),
  );
