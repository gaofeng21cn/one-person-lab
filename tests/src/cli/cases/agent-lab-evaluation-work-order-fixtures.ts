...
export function buildOmaTakeoverEvaluationFixture(tmpDir: string) {
  ...
  const suiteSeed = {
    ...
    tasks: [{
      ...
      target_agent_descriptor_ref: '/tmp/target-agent/contracts/domain_descriptor.json',
      environment: {
  ...
  const observations = {
    ...
    suite_id: ids.suiteId,
    evaluation_owner: ids.evaluationOwner,
    evaluation_receipt_ref: 'evaluation-receipt:opl-foundry-lab/target-agent/takeover',
    authority_boundary: {
      can_write_domain_truth: false,
      can_write_memory_body: false,
    ...
    tasks: [{
      ...
      recovery_probe_observations: [{
        ...
        observation_receipt_ref: 'probe-observation-receipt:opl-foundry-lab/target-agent/resume',
      ...
      trajectory_observation: {
        ...
        observation_owner: ids.evaluationOwner,
        observation_receipt_ref: 'trajectory-observation-receipt:opl-foundry-lab/target-agent/takeover',
      ...
      scorecard_observation: {
        ...
        scorecard_receipt_ref: 'scorecard-receipt:opl-meta-agent/target-agent/takeover',
        passed: true,
      ...
      promotion_gate_observation: {
        ...
        gate_status: 'passed',
        evaluation_owner: ids.evaluationOwner,
        evaluation_receipt_ref: 'promotion-gate-evaluation-receipt:opl-foundry-lab/target-agent/takeover',
      ...
      stage_completion_policy: {
        ...
        policy_receipt_ref: 'stage-policy-receipt:opl-meta-agent/target-agent/takeover',
