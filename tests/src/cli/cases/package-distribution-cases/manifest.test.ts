...
test('packages manifest exposes canonical Release Set coordinates for Package install updates', () => {
  ...
  assert.equal(output.packages_manifest.packages.framework_core.artifact, 'ghcr.io/gaofeng21cn/one-person-lab-framework:0.3.3');
  ...
  assert.equal(
    ...
    'ghcr.io/gaofeng21cn/one-person-lab-packages/mas-scholar-skills:0.2.7',
  );
  assert.equal(output.packages_manifest.packages.package_artifacts['opl-flow'].package_id, 'opl-flow');
  assert.equal(output.packages_manifest.packages.package_artifacts['opl-flow'].package_version, '0.1.23');
  ...
  assert.equal(
    ...
    'ghcr.io/gaofeng21cn/one-person-lab-packages/opl-flow:0.1.23',
  );
  assert.equal(
