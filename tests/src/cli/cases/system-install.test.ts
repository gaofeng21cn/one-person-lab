...
`,
  ...
  try {
    ...
    assert.equal(output.install.runtime_manager_action.executed_actions.some((entry) => ['install_hermes_online_runtime', 'repair_hermes_gateway'].includes(entry.action_id)), false);
