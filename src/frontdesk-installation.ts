...
type FrontDeskInitializeSectionId =
  | 'workspace_root'
  | 'environment'
  | 'modules'
  | 'settings'
...
type FrontDeskInitializePhase = 'workspace_root' | 'environment' | 'review';

type FrontDeskInitializeActionDescriptor = {
  action_id: string;
  label: string;
  description: string;
...
type FrontDeskInitializeChecklistItem = {
  item_id: string;
  label: string;
  status: string;
  required: boolean;
