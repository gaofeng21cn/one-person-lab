      ...
      generatedSkillSections: [
        ...
        },
        {
          ...
          body: [
            ...
            '- Distinguish `review_pdf`, `publication_proof`, and `final_export`. Publication proof requires an explicit publication design profile, resource-path-backed asset resolution for relative figures, a real typesetting backend receipt, rendered-page refs, and rendered-page inspection for hierarchy, captions, figures, tables, callouts, page numbers, overflow, and visual rhythm. Final export additionally requires owner/export acceptance receipts.',
