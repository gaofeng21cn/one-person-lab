      ...
      generatedSkillSections: [
        ...
        },
        {
          ...
          body: [
            ...
            '- Run the BookForge project hygiene scan or an equivalent domain-owned style gate after repairing manuscript, planning, review, metrics, handoff, or source-boundary refs. Active refs must not retain known Red Bird outside-observer phrases such as `公开可观察`, `公开资料显示`, `教育实验观察窗口`, or `观察它如何强调` when the approved stance is practice-involved.',
