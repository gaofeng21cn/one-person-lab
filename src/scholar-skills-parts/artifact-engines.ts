...
const MODULE_ARTIFACT_ENGINES = {
  ...
  'opl.scholarskills.data': {
    ...
    optional_payload_fields: ['dataset_refs', 'variables', 'provenance', 'privacy_constraints'],
    quality_checks: ['dataset_goal_present', 'source_refs_present', 'lineage_readiness_required'],
    candidate_sections: ['data_manifest', 'lineage_plan', 'privacy_boundary', 'readiness_checks'],
  },
