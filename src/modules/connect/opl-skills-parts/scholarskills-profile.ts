...
export const MAS_SCHOLAR_SKILLS_PROFILE_PACKS: MasScholarSkillsPack[] = [
  ...
  {
    pack_id: 'medical-risk-model-transportability-reviewer',
    skill_dir: 'medical-risk-model-transportability-reviewer',
    label: 'Medical risk model transportability reviewer optional specialist',
    role: 'specialist_entry',
    required_by_profile: false,
    default_by_profile: false,
    missing_source_status: 'available-but-not-materialized',
  ...
  {
    pack_id: 'medical-registry-atlas-story-architect',
    skill_dir: 'medical-registry-atlas-story-architect',
    label: 'Medical registry atlas story architect optional specialist',
    role: 'specialist_entry',
    required_by_profile: false,
    default_by_profile: false,
    missing_source_status: 'available-but-not-materialized',
  ...
  {
    pack_id: 'medical-owner-gate-handoff-reviewer',
    skill_dir: 'medical-owner-gate-handoff-reviewer',
    label: 'Medical owner gate handoff reviewer optional specialist',
    role: 'specialist_entry',
    required_by_profile: false,
    default_by_profile: false,
    missing_source_status: 'available-but-not-materialized',
  ...
  {
    pack_id: 'medical-display-regression-debugger',
    skill_dir: 'medical-display-regression-debugger',
    label: 'Medical display regression debugger optional specialist',
    role: 'specialist_entry',
    required_by_profile: false,
    default_by_profile: false,
    missing_source_status: 'available-but-not-materialized',
  ...
  {
    pack_id: 'medical-data-freeze-and-analysis-readiness-reviewer',
    skill_dir: 'medical-data-freeze-and-analysis-readiness-reviewer',
    label: 'Medical data freeze and analysis readiness reviewer optional specialist',
    role: 'specialist_entry',
    required_by_profile: false,
    default_by_profile: false,
    missing_source_status: 'available-but-not-materialized',
