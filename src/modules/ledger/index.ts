...
export { assertMagManifestSustainedConsumptionReceiptInputReady, assertOwnerEvidenceSustainedConsumptionReceiptInputReady, listMagManifestSustainedConsumptionReceipts, listOwnerEvidenceSustainedConsumptionReceipts, magManifestSustainedConsumptionTargetKey, ownerEvidenceSustainedConsumptionTargetKey, preflightMagManifestSustainedConsumptionReceiptInput, preflightOwnerEvidenceSustainedConsumptionReceiptInput, recordMagManifestSustainedConsumptionReceipts, recordOwnerEvidenceSustainedConsumptionReceipts, verifyMagManifestSustainedConsumptionReceipt, verifyOwnerEvidenceSustainedConsumptionReceipt } from './owner-evidence-sustained-consumption-ledger.ts';
export type { MagManifestSustainedConsumptionReceipt, MagManifestSustainedConsumptionReceiptInput, OwnerEvidenceSustainedConsumptionReceipt, OwnerEvidenceSustainedConsumptionReceiptInput } from './owner-evidence-sustained-consumption-ledger.ts';
