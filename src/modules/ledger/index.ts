...
export type { MagManifestSustainedConsumptionReceipt, MagManifestSustainedConsumptionReceiptInput, OwnerEvidenceSustainedConsumptionReceipt, OwnerEvidenceSustainedConsumptionReceiptInput } from './mag-manifest-sustained-consumption-ledger.ts';
