...
function buildValidatedScaffoldConsumptionRefs(input: {
  ...
  return {
    ...
    source_command: 'opl agents scaffold --consumption-evidence',
    next_verification_command: 'opl agents scaffold --consumption-evidence',
...
function buildSurfaceConsumptionProof(repoDir: string, domainId: string, contracts: FrameworkContracts) {
  ...
  return {
    ...
    scaffold_validation_ref: 'opl agents scaffold --validate <ephemeral-new-agent-repo>',
