...
import {
  buildSelfEvolutionCockpit,
  flattenPatchLoopRefs,
  patchLoopCloseoutTargetRefs,
  patchLoopRefFields,
} from './opl-meta-agent-consumption-parts/patch-loop.ts';
import {
  OMA_DOMAIN_ID,
  OMA_PROJECT,
  OMA_WORKSPACE_ENV,
...
function buildOmaSections(payloads: {
  ...
  return {
    ...
    patch_loop_closeout: {
      ...
      required_ref_fields: patchLoopRefFields(),
