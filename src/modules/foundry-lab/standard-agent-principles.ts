...
export const STANDARD_AGENT_PRINCIPLES_POLICY = {
  ...
  principles: [
    ...
    },
    {
      ...
      owner: 'one-person-lab',
      summary:
        'Executors may choose order, tools, substitutions, and safe parallelism inside the declared boundary and must stop at authority, permission, human, safety, or irreversible-write gates.',
    },
    {
