...
export const STANDARD_FOUNDRY_AGENT_SERIES_CONTRACT = {
  ...
  primary_skill_carrier_projection_policy: {
    ...
    codex_plugin_skill_path: 'skills/<canonical_plugin_name>/SKILL.md',
    ...
    repo_local_plugin_mirror_is_compat_carrier_only: true,
    generated_plugin_carrier_is_transport_only: true,
