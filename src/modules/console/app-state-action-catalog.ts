...
export function buildActionCatalog(contracts: FrameworkContracts) {
  ...
  const actions: AppActionCatalogEntry[] = [
    ...
    {
      action_id: 'intelligence_enhancement_status',
      label: 'Read Intelligence Enhancement Mode status',
      surface: 'opl app action execute',
      delegated_surface: 'opl flow intelligence-enhancement status',
      payload_fields: [],
      mutates: 'none_read_only',
      dry_run_supported: false,
    },
    {
      action_id: 'intelligence_enhancement_enable',
      label: 'Enable Intelligence Enhancement Mode',
      surface: 'opl app action execute',
      delegated_surface: 'opl flow intelligence-enhancement enable',
      payload_fields: [],
      mutates: 'local_codex_config_and_codexcont_proxy',
      dry_run_supported: true,
      confirmation_required: true,
      danger_level: 'medium',
      impact: 'installs_or_starts_codexcont_and_routes_codex_provider_to_local_proxy',
      rollback_action_id: 'intelligence_enhancement_disable',
      verify_action_id: 'intelligence_enhancement_status',
    },
    {
      action_id: 'intelligence_enhancement_disable',
      label: 'Disable Intelligence Enhancement Mode',
      surface: 'opl app action execute',
      delegated_surface: 'opl flow intelligence-enhancement disable',
      payload_fields: [],
      mutates: 'local_codex_config_and_codexcont_proxy',
      dry_run_supported: true,
      confirmation_required: true,
      danger_level: 'medium',
      impact: 'stops_codexcont_and_restores_codex_provider_base_url',
      rollback_action_id: 'intelligence_enhancement_enable',
      verify_action_id: 'intelligence_enhancement_status',
    },
    {
      action_id: 'intelligence_enhancement_repair',
      label: 'Repair Intelligence Enhancement Mode service',
      surface: 'opl app action execute',
      delegated_surface: 'opl flow intelligence-enhancement repair',
      payload_fields: [],
      mutates: 'local_codexcont_proxy_service',
      dry_run_supported: true,
      confirmation_required: true,
      danger_level: 'medium',
      impact: 'recreates_codexcont_persistent_service_and_restarts_local_proxy',
      verify_action_id: 'intelligence_enhancement_status',
    },
    {
      action_id: 'intelligence_enhancement_uninstall',
      label: 'Uninstall Intelligence Enhancement Mode',
      surface: 'opl app action execute',
      delegated_surface: 'opl flow intelligence-enhancement uninstall',
      payload_fields: ['confirmation'],
      mutates: 'local_codex_config_and_codexcont_proxy_archive',
      dry_run_supported: true,
      confirmation_required: true,
      danger_level: 'high',
      impact: 'stops_codexcont_restores_codex_provider_and_archives_codexcont_home',
      verify_action_id: 'intelligence_enhancement_status',
    },
    {
