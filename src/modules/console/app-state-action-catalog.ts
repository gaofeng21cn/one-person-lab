...
export function buildActionCatalog(contracts: FrameworkContracts) {
  ...
  const actions: AppActionCatalogEntry[] = [
    ...
    },
    {
      ...
      surface: 'opl app action execute',
      delegated_surface: 'opl connect sync-skills --domain mas-scholar-skills --scope workspace --target-workspace <workspace_root>',
      payload_fields: ['workspace_root'],
      mutates: 'workspace_local_codex_skill',
      dry_run_supported: true,
    },
    {
      ...
      surface: 'opl app action execute',
      delegated_surface: 'opl connect sync-skills --domain mas-scholar-skills --scope quest --target-quest <quest_root>',
      payload_fields: ['quest_root'],
      mutates: 'quest_local_codex_skill',
      dry_run_supported: true,
    },
    {
