...
export { findMasPublicationHandoffOwnerAnswerProjection, findOwnerAnswerProjection, MEDAUTOSCIENCE_PUBLICATION_HANDOFF_OWNER_ANSWER_PROFILE } from './mas-owner-answer-projection.ts';
