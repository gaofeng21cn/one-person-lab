...
export function runtimeRequestInput(
  ...
  return {
    ...
    payload: {
      ...
      surface_id: DOMAIN_ROUTE_RUNTIME_REQUEST_SURFACE_KIND,
      ...
      legacy_runtime_request_kind: 'mas_paper_mission_stage_route',
      ...
      canonical_projection: {
        kind: DOMAIN_ROUTE_RUNTIME_REQUEST_KIND,
        task_kind: DOMAIN_ROUTE_TASK_KIND,
        dedupe_key: domainRouteDedupeKey,
      ...
      stage_run_request: {
        ...
        canonical_requested_by: 'domain_route_handoff',
        legacy_requested_by: 'mas_paper_mission_route_handoff',
        domain_truth_owner: 'med-autoscience',
        runtime_owner: 'one-person-lab',
        command_kind: readback.command_kind,
        route_target: readback.route_target,
