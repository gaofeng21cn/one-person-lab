...
export function protocolCloseoutResumePrompt(attempt: JsonRecord) {
  ...
  return [
    ...
    'If this Attempt has quality-cycle artifact identity, keep it under route_impact.stage_quality_cycle.artifact_refs and route_impact.stage_quality_cycle.artifact_hashes. Do not put artifact_refs or artifact_hashes at the top level; preserve the exact existing refs and hashes without inventing or altering them.',
