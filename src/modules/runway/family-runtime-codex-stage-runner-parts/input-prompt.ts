...
function qualityAttemptPromptLines(attempt: JsonRecord) {
  ...
  const base = [
    ...
    'Only a completed reviewer or re_reviewer Attempt returns route_impact.stage_quality_cycle.outcome, with exactly one of: pass, repair_required, quality_debt, blocked, human_gate.',
    ...
    'A blocked or human_gate reviewer outcome must return blocked_reason, a canonical hard_stop_class, and the applicable domain-owned typed_blocker_ref or human_gate_ref; it does not select a cross-Stage route.',
  ...
  return [
    ...
    ...(attemptRole === 're_reviewer'
      ? [
          ...
          'Required route_impact.stage_quality_cycle fields for re_reviewer: outcome, finding_closures, repair_regressions, critical_new_findings, optional_observations.',
      ...
      : [
          ...
          'Required route_impact.stage_quality_cycle fields for reviewer: outcome, findings.',
