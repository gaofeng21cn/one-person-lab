    ...
    managed_domains: [
      {
        ...
        replacement_role:
          `OPL owns scheduler cadence, provider SLO tick, queue projection/intake bridge, ${OBSERVABILITY_ATTEMPT_LEDGER_LABEL}, and projection; MAS keeps paper-progress SLO semantics, owner receipt, typed blocker, and safe action refs.`,
