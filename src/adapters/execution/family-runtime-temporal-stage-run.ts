...
export type TemporalStageRunRecoveryResume = {
  ...
  resume_after_role?: 'producer' | 'repairer' | 'reviewer';
  reviewer_attempt_ref?: string;
  artifact_producer_attempt_ref?: string;
  artifact_producer_attempt_summary?: TemporalStageRunAttemptSummary;
  producer_attempt_ref?: string;
  producer_attempt_summary?: TemporalStageRunAttemptSummary;
  artifact_refs: string[];
  artifact_hashes: string[];
  artifact_identity_receipt_refs: string[];
  prior_attempt_summaries?: TemporalStageRunAttemptSummary[];
