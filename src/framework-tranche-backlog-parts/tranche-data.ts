...
export const CURRENT_TRANCHE_LANES: TrancheExecutionLane[] = [
  {
    lane_id: 'opl-standard-agent-residue-acceptance-20260622',
    repo: 'one-person-lab',
    priority: 'P0',
    milestone_ids: ['standard_agent_landing_acceptance_guard'],
    lane_status: 'structure_gate_standard_agent_landing_acceptance_readback_non_live_evidence',
    write_set_class: 'standard_agent_acceptance_private_residue_no_second_truth_guard',
    required_surfaces: [
      'source',
      'contract',
      'CLI_readback',
    ...
    non_live_completion_evidence_required: [
      'standard_agent_landing_acceptance_guard_reads_acceptance_contract',
      'standard_agent_landing_acceptance_guard_reads_evidence_status',
      'standard_agent_landing_acceptance_guard_reads_private_residue_decision_ledger',
      'framework_tranche_backlog_current_tranche_selects_standard_agent_acceptance_lane',
    ...
    forbidden_scope: [
      ...
      'target_agent_owner_receipt_signature_by_OPL',
  ...
  {
    lane_id: 'opl-doc-support-profile-guard-20260622',
    repo: 'opl-doc',
    priority: 'P2',
    milestone_ids: ['support_repo_profile_no_resurrection'],
    lane_status: 'structure_gate_support_profile_executable_no_resurrection_audit_non_live_evidence',
    write_set_class: 'opl_doc_support_profile_no_resurrection_guard',
    required_surfaces: [
      'source',
      'contract',
      'CLI_readback',
    ...
    non_live_completion_evidence_required: [
      'support_profile_guard_reads_native_profile_and_support_policy_contracts',
      ...
      'family_plan_json_and_markdown_emit_support_profile_guard',
      'opl_doc_verify_passes',
