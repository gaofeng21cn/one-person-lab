...
export const CURRENT_TRANCHE_LANES: TrancheExecutionLane[] = [
  {
    lane_id: 'mag-source-purity-strict-readback-20260622',
    repo: 'med-autogrant',
    priority: 'P1',
    milestone_ids: ['strict_source_purity_private_wrapper_retirement'],
    lane_status: 'structure_gate_strict_source_purity_guard_readback_non_live_evidence',
    write_set_class: 'strict_source_purity_private_wrapper_repo_native_readback_guard',
    required_surfaces: [
      'source',
      'contract',
      'CLI_readback',
    ...
    non_live_completion_evidence_required: [
      ...
      'MAG_private_surface_policy_source_ref_integrity_consumes_guard_script_ref',
      'MAG_make_test_source_purity_strict_and_verify_source_purity_strict_available',
      'MAG_source_purity_guard_readback_focused_pytest_passed',
      'framework_tranche_backlog_current_tranche_selects_MAG_source_purity_strict_readback_lane',
  ...
  {
    lane_id: 'rca-private-platform-strict-readback-20260622',
    repo: 'redcube-ai',
    priority: 'P1',
    milestone_ids: ['strict_source_purity_private_wrapper_retirement'],
    lane_status: 'structure_gate_private_platform_retirement_strict_readback_non_live_evidence',
    write_set_class: 'rca_private_platform_source_morphology_runtimewatch_domain_action_adapter_readback_guard',
    required_surfaces: [
      'source',
      'contract',
    ...
    non_live_completion_evidence_required: [
      ...
      'RCA_test_private_platform_strict_script_and_verify_private_platform_strict_available',
      'RCA_runtimeWatch_refs_only_and_domain_action_adapter_forbidden_write_readback_available',
      'RCA_private_platform_focused_meta_and_current_program_checks_passed',
      'framework_tranche_backlog_current_tranche_selects_RCA_private_platform_strict_readback_lane',
  ...
  {
    lane_id: 'opl-doc-support-profile-strict-readback-20260622',
    repo: 'opl-doc',
    priority: 'P2',
    milestone_ids: ['support_repo_profile_no_resurrection'],
    lane_status: 'structure_gate_support_profile_no_resurrection_strict_readback_non_live_evidence',
    write_set_class: 'opl_doc_support_profile_extension_only_no_resurrection_guard',
    required_surfaces: [
      'source',
      'CLI_readback',
      'docs',
    ...
    non_live_completion_evidence_required: [
      ...
      'opl_doc_verify_support_profile_strict_available',
      'opl_doc_support_profile_guard_audit_fails_closed_for_legacy_policy_ref',
      'framework_tranche_backlog_current_tranche_selects_opl_doc_support_profile_strict_readback_lane',
