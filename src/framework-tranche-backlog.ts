...
const APP_SHELL_CONVERGENCE_STRUCTURE_READBACK = {
...
const CROSS_REPO_REF_INTEGRITY_GUARD = {
...
function buildPrimitiveRuntimeOwnerRouteGuardReadback(contracts: FrameworkContracts) {
