...
const CURRENT_TRANCHE_LANES: TrancheExecutionLane[] = [
  {
    lane_id: 'app-shell-hermes-convergence-structure-20260621',
    ...
    write_set_class: 'app_shell_convergence_readback_guard',
    required_surfaces: [
      'source',
      'contract',
      'CLI_readback',
    ...
    non_live_completion_evidence_required: [
      'App_owned_shell_convergence_readback_available',
      'active_shell_remains_aionui',
      'Hermes_is_only_foreground_alternative',
      'AGUI_archived_no_resurrection_guard_present',
      'false_ready_boundary_blocks_release_live_and_adoption_claims',
      'App_release_boundary_tests_and_shell_validators_pass',
      'App_main_absorbed_push_and_remote_sha_readback',
    ],
    deferred_evidence: [
      'App_release_cohort',
      'real_user_path',
    ...
    forbidden_scope: [
      'AGUI_default_update_or_polish',
      'active_shell_switch_without_app_shell_adapter_contract',
      'App_release_readiness_claim',
      'packaged_gui_acceptance_claim',
      'Live_Evidence_or_real_user_path_claim',
      'domain_runtime_or_production_ready_claim',
    ],
  },
  {
    lane_id: 'opl-app-shell-convergence-backlog-closeout-20260621',
    repo: 'one-person-lab',
    priority: 'P2',
    milestone_ids: ['app_active_shell_hermes_convergence'],
    lane_status: 'structure_gate_backlog_consumer_lane_non_live_evidence',
    write_set_class: 'opl_framework_backlog_consumes_app_shell_convergence_readback',
    required_surfaces: [
      'source',
      'CLI_readback',
      'API_readback',
    ...
    non_live_completion_evidence_required: [
      ...
      'App_shell_policy_readback_includes_false_ready_boundary',
    ...
    forbidden_scope: [
      'App_repo_writes_from_OPL_consumer_lane',
      'release_owner_receipt_or_App_release_ready_claim',
      'AGUI_default_update_or_polish',
