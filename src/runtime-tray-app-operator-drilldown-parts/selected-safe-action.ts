...
export function summarizeSelectedSafeAction(action: JsonRecord | null) {
  ...
  return {
    ...
    can_authorize_quality_verdict: action.can_authorize_quality_verdict === true,
    can_authorize_artifact_package: action.can_authorize_artifact_package === true,
    can_create_owner_receipt: action.can_create_owner_receipt === true,
