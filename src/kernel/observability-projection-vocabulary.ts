...
export const OBSERVABILITY_SOURCE_LEDGER_FIELD = 'source_ledger';
export const OBSERVABILITY_RECEIPT_LEDGER_FIELD = 'receipt_ref_index';
export const OBSERVABILITY_ATTEMPT_LEDGER_LABEL = 'stage attempt refs projection';
...
export const OBSERVABILITY_PAPER_EVIDENCE_LEDGER_FILE = OBSERVABILITY_COMPAT_PAPER_EVIDENCE_LEDGER_FILE;
