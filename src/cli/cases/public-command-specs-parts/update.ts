...
export function buildUpdateCommandSpecs(
  ...
  return {
    'update status': buildUpdateSpec(
      ...
      ['opl update status --json', 'opl update status --component agent_package_channel --json'],
      getContracts,
    ),
    'update check': buildUpdateSpec(
      ...
      ['opl update check --json', 'opl update check --component runtime_toolchain --json'],
      getContracts,
    ),
    'update plan': buildUpdateSpec(
      ...
      ['opl update plan --json', 'opl update plan --component capability_exposure --json'],
      getContracts,
    ),
    'update apply': buildUpdateSpec(
      ...
      ['opl update apply --component agent_package_channel --json'],
      getContracts,
    ),
    ...
    'update rollback': buildUpdateSpec(
      ...
      ['opl update rollback --component runtime_toolchain --json'],
      getContracts,
    ),
  };
}
