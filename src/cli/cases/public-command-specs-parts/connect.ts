  ...
  const connectCommandSpecs: Record<string, CommandSpec> = {
    ...
    'connect sync-skills': cloneCommandSpec(commandSpecs['skill-sync'], {
      ...
      examples: [
        ...
        'opl connect sync-skills --domain scholarskills --scope workspace --target-workspace /path/to/workspace --json',
        'opl connect sync-skills --domain scholarskills --scope quest --target-quest /path/to/quest --json',
