...
const COMMAND_GROUP_SUMMARIES: Record<string, string> = {
  ...
  'brand-pack': '读取 OPL Pack 的 Domain Pack、authority ABI、generated surface 和验收 surface。',
  ...
  'brand-vault': '读取 OPL Vault 的 evidence、receipt、lineage、state-index 和验收 surface。',
  ...
  pack: '读取 Declarative Domain Pack、authority ABI、pack compiler 和 generated surface 边界读面。',
  ...
  vault: '读取 evidence、receipt、typed blocker、artifact lineage 和 refs-only ledger 读面。',
  ...
  foundry: '读取 OPL Foundry Agent 系列 CLI、Skill、MCP 与 App action 的共享 spine。',
...
function formatHumanRootHelp(payload: ReturnType<typeof buildRootHelp>) {
  const lines = [
    ...
    '  opl pack status                Check the OPL Pack domain-pack surface',
