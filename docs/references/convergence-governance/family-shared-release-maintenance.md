...
- latest audited alignment at 2026-05-26 CST：`med-autogrant` and `redcube-ai` aligned；`med-autoscience` still pins `e3fd0b6be41e858958d42ea400a3e63c4205ff8a` in `pyproject.toml` and `uv.lock`
