...
- Full first-install：首次安装资产，可带 MAS/MAG/RCA、OfficeCLI、companion skills，但不进入 `latest*.yml`；Hermes 与 MDS 都只作为显式可选 companion / provider adapter，不进入默认 Full payload。
