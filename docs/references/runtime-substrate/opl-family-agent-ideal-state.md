...
| 层级 | 理想职责 |
| --- | --- |
| `OPL Framework` | 开发者和技术操作者使用的智能体框架；持有 runtime、contracts、provider、queue、attempt、generated surface、scaffold、Foundry Kernel 与验证门禁。 |
...
- 新 Agent 默认从 OPL scaffold、domain pack、pack compiler、private surface policy 和 Foundry Kernel eval suite 开始，不复制旧 domain repo 的历史私有平台。
