...
- `RedCube AI`
  ...
  - 当前 repo-tracked truth 以 visual-deliverable domain agent、product-entry/session continuity 和 OPL-consumable descriptor/projection 为准；历史 `product frontdoor / federated product entry` 只作为 history/provenance 背景阅读
