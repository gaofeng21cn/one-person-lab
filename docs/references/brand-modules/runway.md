...
| OPL Runway | provider readiness、worker lifecycle/readiness 投影、scheduler/cadence refs、Progress Reconciler、typed queue、attempt ledger、lease、heartbeat、SLO health、repair action、dead-letter 和 runtime blocker。 | 在没有部署 substrate 的情况下承诺进程永久保活；替 domain owner 生成 truth、receipt、typed blocker 或 quality verdict。 |
