...
| `convergence-governance/` | 当前仍可复用的 family 收敛规则、文档生命周期 playbook、intake 模板、shared release 维护和 stage control plane 支撑。一次性 rollout、dated board 与 closeout 记录进入 `docs/history/process/convergence-governance/`。 |
