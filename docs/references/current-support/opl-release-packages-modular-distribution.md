...
| MAS Scholar Skills | 默认 GHCR `one-person-lab-modules/mas-scholar-skills`；Developer Mode 可显式切到 local checkout / path | 否 | Framework capability package，随 capability packages channel 安装和更新，供 MAS/MAG/RCA/OMA 等 agent 同步到 workspace / quest 使用 |
