...
- 固定 GUI 路线：AionUI 是主线，Hermes Desktop 是唯一 foreground alternative，AGUI/CopilotKit 是 archived technical proof。AGUI 只在用户明确要求时 replay，不进入默认验证、日常完善或 release/adoption claim。
