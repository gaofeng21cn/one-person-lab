...
- `Unified Harness Engineering Substrate` 逐步承接共享 runtime substrate
...
## Shared Runtime Substrate v1 应冻结什么
...
- shared runtime substrate v1 的统一实现
- 统一 owner process
...
- 在 `OPL` 顶层把 shared runtime substrate v1 的对象、边界与推广顺序写清
- 明确哪些合同是跨域共享的
...
2. 冻结 shared runtime substrate v1 的统一语言
...
- shared runtime substrate v1 的统一语言
- 对外公开边界与体系说明
...
- 直接宣布 shared runtime substrate 已经实现完成
