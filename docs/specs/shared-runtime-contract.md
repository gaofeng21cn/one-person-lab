...
- `one-person-lab` / `OPL Framework`
  - 负责定义这份共享运行合同的公开语言、machine-readable contract、provider-backed stage runtime、typed queue、stage attempt ledger、receipt/projection、generated surface 与 App/operator read model。
- `one-person-lab-app`
