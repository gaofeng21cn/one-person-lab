...
- `Unified Harness Engineering Substrate`
  - cross-domain invariants, formal-entry semantics, auditability, and layering rules
- `Domain Gateway`
...
| `Unified Harness Engineering Substrate` | shared Harness Engineering constraints and contract layer across domains | `Agent-first`, formal-entry matrix, auditability | shared execution core |
