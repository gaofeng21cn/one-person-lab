...
OPL 不拥有 manuscript、grant package、deck、visual artifact、review/export verdict、submission ready verdict 或 artifact mutation permission。

## 四仓分工

| 仓库 | delivery 层职责 |
| --- | --- |
| `OPL` | 通用 locator、package/export lifecycle shell、restore/retention refs、artifact gallery projection 和 action routing。 |
