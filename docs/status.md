...
当前状态读法同步 `Stage Kernel + Readiness + Derived Diagnostic Lenses`：Stage Kernel 约束启动安全、越权边界、expected receipt、replay/audit、route-back 和 selected executor binding；Readiness 聚合 structural conformance、provider proof、generated surface proof、cleanup proof 与 production evidence tail ledger 的缺口；Derived Diagnostic Lenses 解释 blocker、stale assumption、runtime budget、cohort-loop、failure localization 或 replay gap。它们都不能被写成 domain ready、artifact ready、quality/export/fundability/visual verdict 或 production ready。
