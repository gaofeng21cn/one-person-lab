...
- 当前重点：先把“上游 `Hermes-Agent` 才算真实接入”这条标准冻结下来，再把三个 domain 仓已经 absorbed 的 delta 收进顶层参考面与公开边界
...
3. 先在更轻的业务仓冻结真实的上游 `Hermes-Agent` pilot 条件，再决定何时把该口径提升到联邦层。
4. 避免 reference-grade 与历史迁移文档继续挤占公开主线。
