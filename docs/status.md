...
- 当前完成边界：OPL 已落地 MAS paper autonomy task 的 family queue / projection / guarded dispatch bridge；这不是全部 Hermes-first family runtime 计划的完成信号。Hermes Full App packaging、Hermes gateway stop/restart 真实 soak、MAG/RCA domain adapters、跨仓 notification / approval / dead-letter E2E，以及三篇 MAS live paper controlled apply 到最终交付，仍需按各自 repo truth 和 E2E soak 单独验收。
