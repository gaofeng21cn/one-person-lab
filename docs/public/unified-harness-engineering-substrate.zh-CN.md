...
- `UHS` 是共享总名词
- 其中与长期在线运行最相关的部分，正在收敛为 [Shared Runtime Contract](../active/shared-runtime-contract.zh-CN.md)
- 其中与跨 domain 正式行为最相关的部分，正在收敛为 [Shared Domain Contract](../active/shared-domain-contract.zh-CN.md)
