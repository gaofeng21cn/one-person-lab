...
| [`opl-meta-agent`](https://github.com/gaofeng21cn/opl-meta-agent) | Agent Foundry package | 构建和改进 OPL-compatible agent，Agent Lab、work-order 和 takeover review 策略 | 目标 agent 的领域 truth、通用 Framework runtime |
