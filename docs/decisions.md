...
- `opl connect references verify --references-file <json> --providers crossref,pubmed,openalex,semantic-scholar,crossmark --cache-root <path> --max-retries <n> --json` 成为引用 metadata provider receipt 的稳定入口。
