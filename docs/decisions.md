...
- Framework 目标只保留薄 OCI download/install/update adapter，以及从 OCI、Git/local、
  offline 和其他 native carrier 取得 fresh readback 的 carrier-neutral installed
  aggregation；完整 runtime bytes 缺失时必须报告 `physical_unavailable`。
