...
- 阅读 `../README.md`、`../README.md`、`docs/roadmap*.md`、`docs/operating-model*`、`docs/shared-foundation*`、`docs/shared-foundation-ownership*` 与相关 gateway 文档。
...
1. `docs/references/opl-gateway-rollout.md` 与 `docs/references/opl-gateway-rollout.md` 都把 `Phase G4` 保持在 candidate-index boundary，而不是把它写成当前已收录 surface。
