...
当时后续 agent / maintainer 做外部编排学习时，从本文件开始，再进入相应合同；当前 agent / maintainer 应先读核心五件套、active truth owner、contracts 和 support references，再把本文作为 provenance：
