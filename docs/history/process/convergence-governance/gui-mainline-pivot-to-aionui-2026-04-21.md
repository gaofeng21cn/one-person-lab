...
归档后读法：历史归档。当前实现基线以 [`docs/status.md`](../../../status.md)、[`docs/decisions.md`](../../../decisions.md) 和 [OPL GUI Shell Adapter 边界说明](../../../references/current-support/opl-gui-shell-adapter-boundary.md) 为准。
...
- `Codex` / `Hermes-Agent` 模式切换在当时设想中通过同一套产品设置与运行时配置暴露；当前 executor/provider truth 回到核心五件套、runtime support docs 和 App 仓。
