...
- 手工测试与 hardening 推进顺序也不完全相同：
  ...
  - `redcube-ai` 当前 quickstart 已吸收，且 bootstrap writer 已明确收紧到 `source intake / source research`；同一主线已进一步吸收到 verification-surface 分层与 repo-tracked state migration，并且已预冻结 family-parity continuation board
