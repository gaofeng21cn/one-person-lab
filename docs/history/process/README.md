...
- [2026-06-09 OPL series docs governance ledger chain rollup](./plans/2026-06-09-opl-series-doc-governance-ledger-chain-rollup.md)：折叠并退役 2026-05-26 至 2026-06-09 的 OPL series docs-governance dated ledger chain；当前 truth 回各 repo active owner docs、core docs、contracts/source/tests/read-model、repo-local process index 和 git history。
