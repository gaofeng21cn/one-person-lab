...
- [2026-06-09 OPL whitepaper lifecycle header generator closeout](./plans/2026-06-09-opl-whitepaper-lifecycle-header-generator-closeout.md)：记录 public whitepaper generated Markdown 缺 lifecycle header 的 source-first 修复；当前白皮书正文和 lifecycle metadata 继续归 `opl-whitepaper.source.json`，Markdown/PDF/verification JSON 由 `npm run docs:whitepaper` 生成。
...
- [2026-06-09 OPL Doc series six-repo docs process closeout](./plans/2026-06-09-opl-doc-series-six-repo-docs-process-closeout.md)：记录 clean sibling repo process/history 长清单压缩、SSOT 决策、MAS conflict-safe 写入边界、remaining scope 和下一轮写入范围；当前机器真相仍回各 repo active owner docs、contracts、source、tests、CLI/read-model、runtime ledger 和 repo-local provenance。
