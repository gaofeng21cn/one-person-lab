...
| `2026-05-29-opl-series-doc-governance-tranche-ledger-part-26.md` | OPL series branch/worktree/doc governance tranche ledger part 26。 | 当前 truth 归 OPL release/packages modular distribution support、package manifest source、App release contracts、release evidence 和 live CLI/read-model；ledger 只记录本轮 release/package fixed-version sample 瘦身、fresh package manifest/release-discipline/App operator 读取和下一轮写入范围。 |
