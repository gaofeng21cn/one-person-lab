...
| `2026-05-29-opl-series-doc-governance-tranche-ledger-part-23.md` | OPL series branch/worktree/doc governance tranche ledger part 23。 | 当前 truth 归 OPL runtime naming support、核心五件套、contracts/source/tests、runtime ledger 和 live CLI/read-model；ledger 只记录本轮 runtime naming fixed-date current-state anchor 瘦身、fresh framework/stages/conformance/default-caller/App/worklist 读取和下一轮写入范围。 |
