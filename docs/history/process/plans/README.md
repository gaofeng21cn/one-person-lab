...
| `2026-05-29-opl-series-doc-governance-tranche-ledger-part-16.md` | OPL series branch/worktree/doc governance tranche ledger part 16。 | 当前 truth 归 executor adapter contract、Runtime Manager contract、agent-executor source、active gap plan、核心五件套和 live CLI/read-model；ledger 只记录本轮 Hermes reset / executor evaluation 支撑文档 currentness 瘦身、fresh executor doctor/readiness/worklist 读取、保留的外部 dirty lane 和下一轮写入范围。 |
