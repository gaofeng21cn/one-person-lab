...
Post-snapshot activity observed in the selected OPL tranche: none in the selected files. RCA root had post-snapshot writes in native-PPT docs/prompts and remains outside this tranche.
