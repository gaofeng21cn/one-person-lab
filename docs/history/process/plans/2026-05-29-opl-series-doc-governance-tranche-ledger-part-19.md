# OPL series docs governance tranche ledger part 19

Owner: `One Person Lab`
Purpose: `opl_series_docs_governance_tranche_ledger_part_19`
...
- `docs/references/runtime-substrate/opl-family-agent-ideal-state.md`
- `docs/history/process/plans/2026-05-29-opl-series-doc-governance-tranche-ledger-part-19.md`
...
- Candidate slices: `docs/references/current-support/*`, `docs/references/operating-governance/*`, and roadmap sections that still mix durable target state with dated proof snapshots.
