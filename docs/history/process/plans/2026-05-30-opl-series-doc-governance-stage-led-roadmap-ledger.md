...
- `post_snapshot_activity`: MAS physical-thinning continued writing after snapshot and was absent by closeout recheck; OPL `codex/provider-worker-route-executability-20260530` appeared after snapshot as a dirty worktree; RCA and OPL queuehold had proximal writes. None expanded this tranche.
