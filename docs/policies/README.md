...
| `domain-private-functional-surface-policy.md` | `active_policy` | OPL framework governance owner | 固定 OPL-compatible Agent 私有功能面准入、接口形态、必填证据和退役门；新 Agent 默认只能是 declarative pack + minimal authority functions。 |
