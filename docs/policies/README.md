...
| `reuse-first-governance-policy.md` | `active_policy` | OPL framework governance owner | 固定复用优先治理经验、strict diff gate 语义、沉淀路线和 forbidden ready claims；可执行守门仍归 reuse-first contracts / scan script / verify entry。 |
