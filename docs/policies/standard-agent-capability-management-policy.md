...
| ScholarSkills descriptor、schema、validator、readback contract | `contract_module` | OPL Framework / ScholarSkills contract owner | `contracts/**`、source validator、`opl scholar-skills * --json` readback。 | contract module 不伪装成 true Skill，不替代十三个 active professional Skill，也不授权 domain authority。 |
