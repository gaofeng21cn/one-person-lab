...
| `app_workbench` | One Person Lab App / OPL product surface | 已有 `app_operator_drilldown` runtime 页面消费路径，并已投影 evidence request、replacement coverage 和 cleanup plan；继续补真实用户路径、截图、发布包和长时证据，不做 domain truth owner。 |
