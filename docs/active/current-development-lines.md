...
| `opl_app_runtime_workbench` | OPL App 能从一个工作台读取 provider readiness/proof、stage attempt、domain progress、human gate、artifact refs、source refs、safe action receipts、controlled apply refs、transition bridge evidence refs、transition evidence filter flags、restore proof 和 stage-attempt 分组/过滤摘要。 |
