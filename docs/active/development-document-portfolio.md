...
| `med-autoscience` | MAS latest domain-route task dispatch naming commit, diff-check result, aggregate owner-route/domain-route/test-lane pytest result, earlier specificity followthrough pytest result, worktree retention classification. | none |
