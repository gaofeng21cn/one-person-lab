...
| `med-autogrant` | dated support specs | `docs/specs/specs_lifecycle_map.md` | `owner_lane` | `spec_support` | possible `human_doc:*` / contract refs | none this tranche | active specs and contract-linked support | L1/L3 depending refs | future inbound-ref scan | mag | deferred |
...
| `redcube-ai` | history/process re-expansion guard | `docs/history/process/README.md` | `governance_ssot` | `history_index` | none | future topic-level row only | proof-by-proof ledgers | L1 | future targeted scan | rca | deferred |
...
| `opl-bookforge` | evidence package file-list duplication | `docs/evidence/README.md` | `governance_ssot` | `active_truth` | no production/owner acceptance claim | `docs/status.md` compact evidence summary | evidence payloads, contracts, pilot artifacts | L1 | `git diff --check`; targeted evidence scan | bookforge | selected |
