...
| Hermes-first online substrate、Hermes Kernel as default product runtime | history/provenance/diagnostic/evaluation reference；当前默认主线是 provider-backed framework |
