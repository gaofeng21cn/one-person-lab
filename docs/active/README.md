...
- `one-person-lab-app-repo-split-plan.md`：One Person Lab App 独立产品仓与 AionUI shell 子目录化 closeout；固定 Framework repo、App repo 和 upstream-backed GUI adapter 的 owner split。
