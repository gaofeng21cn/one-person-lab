...
- `standard-agent-private-platform-inventory.md`：跨 MAS/MAG/RCA/opl-meta-agent 的私有平台化 inventory，按 domain authority、OPL migration candidate、thin adapter 和 split-before-migration 分类记录大控制面、active caller、保留 authority、可上收 generic 子域、迁移门槛与验证入口。
