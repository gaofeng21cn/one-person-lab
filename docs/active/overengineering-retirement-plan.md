...
| CLI parser tail | done | 100% | `2026-07-07` family-runtime queue / scheduler option parsing 收到邻近 thin helper，focused parser tests 与 typecheck 作为行为证据。 | 仍需继续按新增 diff 守住 command registry；不为统一指标引入新 CLI framework。 |
