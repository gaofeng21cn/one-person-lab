...
6. 验证 Developer Mode / Agent Lab repair route：系统配置、App 开关、GitHub 身份/权限检测、外围 AI 巡检、repo fix / commit 和 fork / PR 路由已经形成机器面；下一步用真实 repo 问题跑 direct-fix 与 fork/PR closeout 证据。
