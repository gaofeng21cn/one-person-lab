...
- Fresh evidence：full scan 当前为 `finding_count=2006`、`hard_gate_finding_count=744`、`advisory_finding_count=1262`、`decisioned_finding_count=2006`、`undecisioned_finding_count=0`；`custom_observability_ledger=1262`、`phase10-src-modules-observability=0`。该证据只证明 diagnostic projection 分类更准，不证明真实 Collector/exporter、runtime ready、domain ready、artifact ready、production ready 或 owner acceptance。
