...
5. New Agent / OPL Meta Agent 的真实 production consumption：fresh scaffold cohort 与 OMA structural consumption 已通过；managed install/update 和 owner receipt scaleout 已可由机器 receipt 计为 observed，但 App live path 与 long-soak 仍未闭合。
