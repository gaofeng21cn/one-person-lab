...
- Current management-surface truth: `opl projects / workspace-status / runtime-status / dashboard` now provide the first top-level management layer for project, workspace, session, and runtime visibility.
