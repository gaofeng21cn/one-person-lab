...
from opl_framework.family_orchestration import (
    ...
    build_family_product_entry_product_entry_orchestration,
...
def test_build_family_product_entry_orchestration_materializes_action_graph_and_gate_previews() -> None:
    ...
    assert payload["action_graph"]["graph_id"] == "redcube_product_entry_product_entry_graph"
...
def test_build_family_product_entry_product_entry_orchestration_materializes_canonical_product_entry_graph() -> None:
    payload = build_family_product_entry_product_entry_orchestration(
        graph_id="redcube_product_entry_product_entry_graph",
        target_domain_id="redcube_ai",
        graph_kind="visual_deliverable_orchestration",
