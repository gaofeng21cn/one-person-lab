...
from .family_product_entry_preset import (
    build_family_product_entry_preset_graph_parts,
    resolve_family_product_entry_preset,
)
...
def build_family_product_entry_product_entry_orchestration(
    *,
    graph_id: str,
    target_domain_id: str,
    graph_kind: str,
    ...
    session_locator_field: str,
    checkpoint_locator_field: str,
    opl_hosted_title: str | None = None,
    opl_hosted_surface_kind: str | None = None,
    review_gate_title: str | None = None,
    ...
    intake_evidence_companion: Mapping[str, Any] | None = None,
    project_profile_companion: Mapping[str, Any] | None = None,
    product_entry_node_id: str | None = None,
    direct_node_id: str | None = None,
    opl_hosted_node_id: str | None = None,
    progress_node_id: str | None = None,
    direct_transition_event: str | None = None,
    opl_hosted_transition_event: str | None = None,
    direct_progress_event: str | None = None,
    opl_hosted_progress_event: str | None = None,
) -> dict[str, Any]:
    resolved = resolve_family_product_entry_preset(
        product_entry_node_id=product_entry_node_id,
        direct_node_id=direct_node_id,
        opl_hosted_node_id=opl_hosted_node_id,
        progress_node_id=progress_node_id,
        direct_transition_event=direct_transition_event,
        opl_hosted_transition_event=opl_hosted_transition_event,
        direct_progress_event=direct_progress_event,
        opl_hosted_progress_event=opl_hosted_progress_event,
        opl_hosted_title=opl_hosted_title,
        opl_hosted_surface_kind=opl_hosted_surface_kind,
    )
    graph_parts = build_family_product_entry_preset_graph_parts(
        product_entry_title=product_entry_title,
        product_entry_surface_kind=product_entry_surface_kind,
        direct_title=direct_title,
        direct_surface_kind=direct_surface_kind,
        progress_title=progress_title,
        progress_surface_kind=progress_surface_kind,
        review_gate_id=review_gate_id,
        review_gate_title=review_gate_title,
        review_gate_status=review_gate_status,
        review_surface=review_surface,
        resolved=resolved,
    )

    return build_family_product_entry_orchestration(
        graph_id=graph_id,
        target_domain_id=target_domain_id,
        graph_kind=graph_kind,
        graph_version=graph_version,
        nodes=graph_parts["nodes"],
        edges=graph_parts["edges"],
        entry_nodes=graph_parts["entry_nodes"],
        exit_nodes=graph_parts["exit_nodes"],
        human_gates=graph_parts["human_gates"],
        checkpoint_nodes=graph_parts["checkpoint_nodes"],
        human_gate_previews=graph_parts["human_gate_previews"],
        resume_surface_kind=resume_surface_kind,
        session_locator_field=session_locator_field,
        checkpoint_locator_field=checkpoint_locator_field,
        action_graph_ref=action_graph_ref,
