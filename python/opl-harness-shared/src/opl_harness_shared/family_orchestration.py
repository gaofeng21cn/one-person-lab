...
def build_family_product_entry_product_entry_orchestration(
    *,
    ...
    session_locator_field: str,
    checkpoint_locator_field: str,
    federated_title: str | None = None,
    federated_surface_kind: str | None = None,
    ...
    federated_transition_event: str | None = None,
    ...
    resolved = resolve_family_product_entry_preset(
        ...
        federated_transition_event=federated_transition_event,
        direct_progress_event=direct_progress_event,
        federated_progress_event=federated_progress_event,
        federated_title=federated_title,
        federated_surface_kind=federated_surface_kind,
    )
