...
export PYTHONPYCACHEPREFIX="${PYTHONPYCACHEPREFIX:-${repo_temp_root}/python/pycache}"
export PYTEST_ADDOPTS="${PYTEST_ADDOPTS:-} -p no:cacheprovider -o cache_dir=${repo_temp_root}/python/pytest-cache"
export UV_CACHE_DIR="${UV_CACHE_DIR:-${repo_temp_root}/uv/cache}"
export UV_PROJECT_ENVIRONMENT="${UV_PROJECT_ENVIRONMENT:-${repo_temp_root}/uv/project-venv}"
export PIP_CACHE_DIR="${PIP_CACHE_DIR:-${repo_temp_root}/pip/cache}"
export NPM_CONFIG_CACHE="${NPM_CONFIG_CACHE:-${repo_temp_root}/npm/cache}"
export npm_config_cache="${npm_config_cache:-${NPM_CONFIG_CACHE}}"
export NODE_COMPILE_CACHE="${NODE_COMPILE_CACHE:-${repo_temp_root}/node/compile-cache}"
export CARGO_TARGET_DIR="${CARGO_TARGET_DIR:-${repo_temp_root}/cargo-target}"
export XDG_CACHE_HOME="${XDG_CACHE_HOME:-${repo_temp_root}/xdg-cache}"
