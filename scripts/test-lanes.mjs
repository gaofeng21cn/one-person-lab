...
const fastTestFiles = [
  ...
  'tests/src/family-runtime-domain-intake-paper-mission-route-handoff.test.ts',
  'tests/src/family-runtime-domain-intake-transition-task-inputs.test.ts',
...
const lanes = {
  ...
  meta: [
    nodeTest([
      ...
      'tests/src/cli/cases/framework-tranche-backlog-app-shell.test.ts',
      'tests/src/cli/cases/framework-tranche-backlog-generated-domain-source.test.ts',
      'tests/src/cli/cases/framework-tranche-backlog-index.test.ts',
      'tests/src/cli/cases/framework-tranche-backlog-runtime-guards.test.ts',
