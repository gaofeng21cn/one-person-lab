...
const readModelGateTestFiles = [
  ...
  'tests/src/cli/cases/family-runtime-queue-held-redrive-guard.test.ts',
  ...
  'tests/src/cli/cases/runtime-app-operator-drilldown-provider-worker-progress.test.ts',
  ...
  'tests/src/cli/cases/runtime-app-operator-drilldown-domain-dispatch-guards.test.ts',
