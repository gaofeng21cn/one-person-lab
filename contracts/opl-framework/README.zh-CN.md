...
- Pack OS 读取通用 capability-pack descriptor，生成 refs-only lock、content hash、artifact locator refs、lifecycle refs 和 review receipt transport，不把 pack lock、review receipt transport 或 provider completion 升级成 domain ready、quality verdict、artifact authority 或 publication/export readiness
