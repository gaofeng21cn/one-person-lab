...
- brand-module governance 通过 registry、模块自有品牌 CLI frontdoor、read-model projection、validation gate 和 false-authority boundary，让 Charter、Atlas、Workspace、Stagecraft、Runway、Vault、Console、Foundry Lab 与 Connect 保持 Workspace-level structural baseline
