...
- `stage-run-kernel-contract.json`: refs-only StageRun spec/status/event-log/read-model substrate, observed_generation, retry budget, hold scope, and domain adoption boundary.
