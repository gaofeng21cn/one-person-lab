...
- `stage-owner-receipt.schema.json`: owner-signed stage receipt shape consumed by OPL for success or route handoff without granting OPL receipt authority.
