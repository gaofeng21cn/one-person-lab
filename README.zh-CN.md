...
- **AI-first、AI 原生专家判断优先、contract-light**：阶段内的拆解、创作、判断和修订尽量交给 Codex 等 AI executor；合同只保边界、安全、审计和可恢复性下限，避免用机械检查替代专家 stage 判断。
...
OPL 采用 AI-first、AI 原生专家判断优先、contract-light 原则：框架合同负责 owner boundary、权限、安全、审计、receipt、阻塞与恢复这些下限；开放式规划、写作、评审、路线判断和修订继续由被选中的 AI executor 与领域智能体承担，以最大程度吸收后续 AI 能力提升。
