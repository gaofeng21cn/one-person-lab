...
它把复杂知识工作拆成一个个能推进的阶段：准备材料、执行创作、质量审核、修订完善、交付收口。每个阶段都围绕一个真实成果增量工作，而不是只跑完一个流程节点。AI 可以在同一阶段里整理资料、提出候选方案、比较取舍、调用工具、接受审阅并继续修订；用户看到的是进度、文件、证据、阻塞和下一步都被清楚保留下来。
...
论文、基金、汇报、专利不是一次问答能完成的。OPL 让每一轮工作都有明确目标、产出、检查和下一步，避免长任务散落在聊天记录里。
...
医学研究、基金写作、视觉汇报和 Agent 构建分别由不同 Foundry Agent 承担。用户看到的是统一工作台，背后每个专业 Agent 保留自己的材料理解、判断标准、审阅方式和交付边界。
...
普通自动化流程擅长处理固定步骤：先做 A，再做 B，最后输出 C。复杂知识工作不一样。写一篇论文、改一个基金本子、做一套正式汇报，过程中经常需要反复判断、比较、推翻、重写和审阅。

这里的核心概念是**认知计算**：让 AI 在一个可观察、可接力的阶段里完成理解、比较、创作、审阅和修订，而不是只按预设流程调用工具。OPL 把进度、证据、文件和交接边界管理起来，把开放式思考和专业判断留给合适的 AI 与专家。

One Person Lab 的优势在于，它既让用户看得见“现在做到哪一步、下一步是什么、卡在哪里”，又给专业 AI 足够空间在每个阶段里做真正的专家工作：读资料、生成多个方案、比较优劣、根据审阅意见修订，直到形成可检查的下一版成果。

这也是它和只会“按流程调用工具”的系统不同的地方：OPL 关心的不是某个节点有没有跑完，而是成果是否真的往前推进，文件、证据、审阅和交付是否能被继续接力。

## 和普通工作流工具的区别

普通工作流工具更适合确定性任务，例如调用几个工具、填几个字段、生成一个固定输出。高价值知识工作更像一个专业团队在持续推进项目：有人准备材料，有人创作，有人审阅，有人修订，有人收口交付。OPL 把这些角色和阶段组织起来，让 AI 不只完成动作，而是持续形成可检查、可修改、可交付的成果。
...
| **Foundry Agents** | 专业工作场景 | MAS、MAG、RCA 等专业 Agent 分别提供医学研究、基金写作、视觉交付等专业能力和交付物。 |

这三层形成一条清晰链路：用 OPL Framework 托管专业 Agent，再把框架和 Agent 打包成普通用户可直接使用的桌面产品。

如果只是使用产品，不需要理解这些仓库分工。对开发者来说：`one-person-lab` 维护框架和命令行，`one-person-lab-app` 维护桌面产品和发布体验，MAS、MAG、RCA 等仓库维护各自专业领域的能力、判断标准和交付物。
