...
- **AI-first, contract-light**：阶段内的拆解、创作、判断和修订尽量交给 Codex 等 AI executor；合同只约束边界、安全、审计和可恢复性，避免把智能行为写死。
...
OPL 采用 AI-first, contract-light 原则：框架合同负责 owner boundary、权限、安全、审计、receipt、阻塞与恢复；开放式规划、写作、评审、路线判断和修订继续由被选中的 AI executor 与领域智能体承担，以最大程度吸收后续 AI 能力提升。
